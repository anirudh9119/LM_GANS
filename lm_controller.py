...
class LMController(Controller):
    ...
    def __init__(self, experiment_id, config):
        ...
        ServerLogger(filename='/Tmp/anirudhg/LM_GANS/pbt_logs/{}.log.jsonl.gz'.format(self.experiment_id),
...
if __name__ == '__main__':
    ...
    shutil.copyfile(sys.argv[1], '/Tmp/anirudhg/LM_GANS/pbt_logs/{}.config.json'.format(experiment_id))
    # Start controller
