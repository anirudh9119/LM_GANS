...
def train(dim_word=100,  # word vector dimensionality
    ...
    trng_sampled,\
        ...
        f_get_sampled,\
        bern_dist_sampled,\
        uniform_sampling_sampled,\
        one_hot_sampled_sampled,\
    ...
    discriminator_gan_updates = lasagne.updates.adam(d.loss,
                                                     d.params,
                                                     learning_rate = 0.0001)
        ...
        for x in train:
            ...
            if numpy.mod(uidx, sampleFreq) == 0:
                ...
                if x.shape[1] == 30 and genx.shape[1] == 30 and x_mask.shape[1] == 30 and genx_mask.shape[1] == 30:
                        ...
                        results_map = train_discriminator(x, x_mask, bern_dist.astype('float32'),
